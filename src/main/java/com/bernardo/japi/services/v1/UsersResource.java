...
import com.bernardo.japi.BusinessManager;
...
public class UsersResource {
	...
	notes = "This API retrieves the public information for the user (Private info is return if this is the oauth user)" +
	...
	public Response updateUser(
		      @ApiParam(value = "User ID", required = true) @PathParam("userId") String userId, String jsonString) {
	...
	public Response deleteUser(@PathParam("userId") String userId) {
		...
		return Response.status(Response.Status.BAD_REQUEST)
				.entity("{\"error\":\"Cold Not Delete User\", \"status\":\"FAIL\"}")
				.build();		
	}		
